...
def upload_dataframe_to_bigquery(df: pd.DataFrame, project_id: str, dataset_name: str, table_name: str) -> None:
...
def sanitize_column_names(df: pd.DataFrame) -> pd.DataFrame:
    ...
    logging.info(f"Found the following duplicate column names: {duplicate_column_names}")
